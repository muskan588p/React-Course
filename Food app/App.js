  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img className="logo" src="https://assets.zenn.com/strapi_assets/food_logo_5fbb88038c.png" alt="Tasty Trails Logo" />
      </div>
  ...
  return (
    <div className="res-card" style={{ backgroundColor: "#f0f0f0" }}>
      <img
        className="res-logo"
        alt="res-logo"
        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRobjfQgZgPDP5bQW87XsaQu0-Bj-T6T9K0Ug&s"
        // src={
    ...
    <div className="body">
      ...
      {/* <RestaurantCard restaurantData={restaurantList[0]} />  */}
        {restaurantList.map((restaurant) => (
          <RestaurantCard
            key={restaurant.info.id}    //each child in list should hace UNIQUE KEY PROPERTY
